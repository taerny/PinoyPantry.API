...
namespace PinoyPantry.API.Migrations
{
    ...
    [Migration("20260908100857_AddPasabuyOrderItems")]
    partial class AddPasabuyOrderItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PinoyPantry.API.Models.NewsletterSubscriber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PinoyPantry.API.Models.PasabuyOrder", b =>
                {
                    ...
                    b.Property<string>("ItemsRequested")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PinoyPantry.API.Models.PasabuyOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PasabuyOrderId");

                    b.ToTable("PasabuyOrderItems");
                });
            ...
            modelBuilder.Entity("PinoyPantry.API.Models.ProductBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PinoyPantry.API.Models.PasabuyOrderItem", b =>
                {
                    b.HasOne("PinoyPantry.API.Models.PasabuyOrder", "PasabuyOrder")
                        .WithMany("Items")
                        .HasForeignKey("PasabuyOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PasabuyOrder");
                });

            modelBuilder.Entity("PinoyPantry.API.Models.ProductBatch", b =>
                {
                    b.HasOne("PinoyPantry.API.Models.Product", "Product")
                        .WithMany("Batches")
